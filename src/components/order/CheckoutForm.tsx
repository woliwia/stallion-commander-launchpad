  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <img 
          src="/lovable-uploads/094efa2f-5e4a-4a53-8648-d3914b8966f6.png" 
          alt="Accepted payment methods: Mastercard, Visa, Apple Pay, American Express, Google Pay, Discover"
