...
export const BreakingNewsBar = () => {
  return (
    <Link
      to="/order"
      className="group relative block focus:outline-none focus-visible:ring-4 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-[#b40000]"
      aria-label="Shop Stallion Commander now"
    >
      <div className="relative overflow-hidden border-b-2 border-white/30 bg-gradient-to-r from-[#7f0000] via-[#c50000] to-[#ff1a1a] text-white shadow-[0_12px_30px_rgba(229,57,53,0.45)]">
        ...
        <div className="relative flex items-center gap-3 px-4 py-2 sm:gap-4 sm:px-6 sm:py-2.5">
          ...
          <span className="inline-flex shrink-0 items-center rounded-full bg-white px-3 py-1 text-[0.7rem] font-extrabold uppercase tracking-wide text-[#900000] transition-all duration-200 group-hover:translate-x-1 group-hover:bg-white group-hover:text-[#b60000] sm:px-4 sm:py-1.5 sm:text-sm">
