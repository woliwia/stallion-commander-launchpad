    ...
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-card relative">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="text-center max-w-4xl mx-auto mb-8 sm:mb-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-foreground mb-6 sm:mb-8">
            EXPERIENCE THE
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          {benefits.map((benefit, index) => (
            <div 
              key={index} 
              className="bg-card border border-border p-6 sm:p-8 lg:p-10 rounded-2xl hover:bg-gradient-card hover:shadow-premium transition-all duration-300 group animate-slide-up"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="bg-primary/10 w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-2xl flex items-center justify-center mb-4 sm:mb-6 lg:mb-8 group-hover:bg-primary/20 transition-colors">
                <benefit.icon className="w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 text-primary" />
              </div>
              
              <h3 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-bold text-foreground mb-3 sm:mb-4 lg:mb-6">
                {benefit.title}
              </h3>
