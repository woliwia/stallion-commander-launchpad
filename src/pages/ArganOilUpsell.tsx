        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12 text-left max-w-3xl mx-auto">
            <p className="text-lg mb-6 text-foreground">
              Upgrade Your Results with Pure Argan Oil — the Ultimate All-in-One Formula for Men. Add it today for just <span style={{ color: '#21BFF4' }}>$30.60 each</span> <span className="text-red-500">(regularly $105)</span> — that's over <span style={{ color: '#21BFF4' }}>71% OFF!</span>
            </p>
